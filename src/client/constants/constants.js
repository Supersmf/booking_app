...
export const CONFIRM_CUSTOMER_REQUEST = 'CONFIRM_CUSTOMER_REQUEST';
export const CONFIRM_CUSTOMER_SUCCESS = 'CONFIRM_CUSTOMER_SUCCESS';
export const CONFIRM_CUSTOMER_FAILURE = 'CONFIRM_CUSTOMER_FAILURE';
